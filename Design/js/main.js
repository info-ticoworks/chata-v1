...
$('#contact_send').click(function()
{
    ...
    {
        $('#contact_status_message').html("<div class = 'alert alert-danger'>¡Uno o más campos están vacíos!<div>");
    }
    else
    {
        if(!ValidateEmail(contact_email))
        {
            $('#contact_status_message').html("<div class = 'alert alert-danger'>¡Por favor introduzca una dirección de correo electrónico válida!<div>");
        }
        else
        {
            $.ajax({
                ...
                {
                    alert("Se ha producido un ERROR interno, por favor, inténtalo más tarde.");
                }
            });
        }
    }
